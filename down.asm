...
stat(const char *n, struct stat *st)
{
 ...
 1bd:	e8 18 01 00 00       	call   2da <open>
  if(fd < 0)
 ...
 1d1:	50                   	push   %eax
 1d2:	e8 cb 00 00 00       	call   2a2 <fstat>
  close(fd);
 1d7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 1da:	89 c6                	mov    %eax,%esi
  close(fd);
 1dc:	e8 29 01 00 00       	call   30a <close>
  return r;
...
000002a2 <fstat>:
SYSCALL(fstat)
 2a2:	b8 08 00 00 00       	mov    $0x8,%eax
 2a7:	cd 40                	int    $0x40
 2a9:	c3                   	ret    
 ...
 349:	85 d2                	test   %edx,%edx
{
 ...
 3b0:	e8 2d ff ff ff       	call   2e2 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 481:	e8 5c fe ff ff       	call   2e2 <write>
 ...
 533:	57                   	push   %edi
 534:	53                   	push   %ebx
 535:	e8 a8 fd ff ff       	call   2e2 <write>
        while(*s != 0){
 ...
 587:	e8 56 fd ff ff       	call   2e2 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 69e:	56                   	push   %esi
 69f:	e8 1e fc ff ff       	call   2c2 <sbrk>
  if(p == (char*)-1)
