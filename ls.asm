...
00000100 <ls>:
{
 ...
 10f:	6a 00                	push   $0x0
 111:	57                   	push   %edi
 112:	e8 d3 04 00 00       	call   5ea <open>
 ...
 129:	56                   	push   %esi
 12a:	50                   	push   %eax
 12b:	e8 82 04 00 00       	call   5b2 <fstat>
 ...
 155:	53                   	push   %ebx
 156:	e8 bf 04 00 00       	call   61a <close>
 ...
 213:	e8 02 04 00 00       	call   61a <close>
    return;
...
stat(const char *n, struct stat *st)
{
 ...
 4cd:	e8 18 01 00 00       	call   5ea <open>
  if(fd < 0)
 ...
 4e1:	50                   	push   %eax
 4e2:	e8 cb 00 00 00       	call   5b2 <fstat>
  close(fd);
 4e7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 4ea:	89 c6                	mov    %eax,%esi
  close(fd);
 4ec:	e8 29 01 00 00       	call   61a <close>
  return r;
 ...
 659:	85 d2                	test   %edx,%edx
{
 ...
 6c0:	e8 2d ff ff ff       	call   5f2 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 730:	e8 bd fe ff ff       	call   5f2 <write>
 ...
 791:	e8 5c fe ff ff       	call   5f2 <write>
 ...
 7a8:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 7aa:	e8 43 fe ff ff       	call   5f2 <write>
  for(i = 0; fmt[i]; i++){
 ...
 843:	57                   	push   %edi
 844:	53                   	push   %ebx
 845:	e8 a8 fd ff ff       	call   5f2 <write>
        while(*s != 0){
 ...
 897:	e8 56 fd ff ff       	call   5f2 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 9ae:	56                   	push   %esi
 9af:	e8 1e fc ff ff       	call   5d2 <sbrk>
  if(p == (char*)-1)
