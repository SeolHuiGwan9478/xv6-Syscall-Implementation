...
main(void)
{
  ...
  19:	e8 ac 03 00 00       	call   3ca <open>
  1e:	83 c4 10             	add    $0x10,%esp
  21:	85 c0                	test   %eax,%eax
  23:	0f 88 bf 00 00 00    	js     e8 <main+0xe8>
    mknod("console", 1, 1);
    open("console", O_RDWR);
  }
  dup(0);  // stdout
  ...
  2c:	6a 00                	push   $0x0
  2e:	e8 6f 03 00 00       	call   3a2 <dup>
  dup(0);  // stderr
  33:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  3a:	e8 63 03 00 00       	call   3a2 <dup>

  printf(1, "Welcome to HUFS xv6 Operating System! \n\n");
  3f:	58                   	pop    %eax
  40:	5a                   	pop    %edx
  41:	68 a0 08 00 00       	push   $0x8a0
  46:	6a 01                	push   $0x1
  48:	e8 83 04 00 00       	call   4d0 <printf>
  printf(1, "Name: Hui-Gwan Seol \n");
  4d:	59                   	pop    %ecx
  4e:	5b                   	pop    %ebx
  4f:	68 30 08 00 00       	push   $0x830
  54:	6a 01                	push   $0x1
  56:	e8 75 04 00 00       	call   4d0 <printf>
  printf(1, "ID: 201901881 \n");
  5b:	58                   	pop    %eax
  5c:	5a                   	pop    %edx
  5d:	68 46 08 00 00       	push   $0x846
  62:	6a 01                	push   $0x1
  ...
  73:	68 56 08 00 00       	push   $0x856
  78:	6a 01                	push   $0x1
  7a:	e8 51 04 00 00       	call   4d0 <printf>
    pid = fork();
  7f:	e8 d6 02 00 00       	call   35a <fork>
    if(pid < 0){
  ...
  89:	89 c3                	mov    %eax,%ebx
    if(pid < 0){
  8b:	78 24                	js     b1 <main+0xb1>
      printf(1, "init: fork failed\n");
      exit();
    }
    if(pid == 0){
  8d:	74 35                	je     c4 <main+0xc4>
  8f:	90                   	nop
      exec("sh", argv);
  ...
  ba:	e8 11 04 00 00       	call   4d0 <printf>
      exit();
  bf:	e8 9e 02 00 00       	call   362 <exit>
      exec("sh", argv);
  c4:	50                   	push   %eax
  c5:	50                   	push   %eax
  c6:	68 7c 0b 00 00       	push   $0xb7c
  cb:	68 7c 08 00 00       	push   $0x87c
  d0:	e8 b5 02 00 00       	call   38a <exec>
      printf(1, "init: exec sh failed\n");
  d5:	5a                   	pop    %edx
  d6:	59                   	pop    %ecx
  d7:	68 7f 08 00 00       	push   $0x87f
  dc:	6a 01                	push   $0x1
  de:	e8 ed 03 00 00       	call   4d0 <printf>
      exit();
  e3:	e8 7a 02 00 00       	call   362 <exit>
    mknod("console", 1, 1);
  e8:	51                   	push   %ecx
  e9:	6a 01                	push   $0x1
  eb:	6a 01                	push   $0x1
  ed:	68 28 08 00 00       	push   $0x828
  f2:	e8 e3 02 00 00       	call   3da <mknod>
    open("console", O_RDWR);
  f7:	5b                   	pop    %ebx
  f8:	58                   	pop    %eax
  f9:	6a 02                	push   $0x2
  fb:	68 28 08 00 00       	push   $0x828
 100:	e8 c5 02 00 00       	call   3ca <open>
 105:	83 c4 10             	add    $0x10,%esp
 108:	e9 1c ff ff ff       	jmp    29 <main+0x29>
...
stat(const char *n, struct stat *st)
{
 ...
 2ad:	e8 18 01 00 00       	call   3ca <open>
  if(fd < 0)
 ...
 2c1:	50                   	push   %eax
 2c2:	e8 cb 00 00 00       	call   392 <fstat>
  close(fd);
 2c7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2ca:	89 c6                	mov    %eax,%esi
  close(fd);
 2cc:	e8 29 01 00 00       	call   3fa <close>
  return r;
 ...
 439:	85 d2                	test   %edx,%edx
{
 ...
 467:	f7 f1                	div    %ecx
 469:	0f b6 92 d4 08 00 00 	movzbl 0x8d4(%edx),%edx
  }while((x /= base) != 0);
 ...
 4a0:	e8 2d ff ff ff       	call   3d2 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 571:	e8 5c fe ff ff       	call   3d2 <write>
 ...
 588:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 58a:	e8 43 fe ff ff       	call   3d2 <write>
  for(i = 0; fmt[i]; i++){
 ...
 623:	57                   	push   %edi
 624:	53                   	push   %ebx
 625:	e8 a8 fd ff ff       	call   3d2 <write>
        while(*s != 0){
 ...
 677:	e8 56 fd ff ff       	call   3d2 <write>
        ap++;
 ...
 684:	e9 8f fe ff ff       	jmp    518 <printf+0x48>
          s = "(null)";
 689:	bb cc 08 00 00       	mov    $0x8cc,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a1:	a1 84 0b 00 00       	mov    0xb84,%eax
{
 ...
 6dd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6df:	a3 84 0b 00 00       	mov    %eax,0xb84
}
 6e4:	5b                   	pop    %ebx
 6e5:	5e                   	pop    %esi
 6e6:	5f                   	pop    %edi
 ...
 6f6:	72 ce                	jb     6c6 <free+0x26>
{
 ...
 717:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 71a:	a3 84 0b 00 00       	mov    %eax,0xb84
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 15 84 0b 00 00    	mov    0xb84,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 77f:	73 47                	jae    7c8 <malloc+0x98>
    ...
    if(p == freep)
 781:	39 05 84 0b 00 00    	cmp    %eax,0xb84
 787:	89 c2                	mov    %eax,%edx
 789:	75 ed                	jne    778 <malloc+0x48>
  p = sbrk(nu * sizeof(Header));
 78b:	83 ec 0c             	sub    $0xc,%esp
 78e:	56                   	push   %esi
 78f:	e8 1e fc ff ff       	call   3b2 <sbrk>
  if(p == (char*)-1)
 ...
 7a6:	e8 f5 fe ff ff       	call   6a0 <free>
  return freep;
 7ab:	8b 15 84 0b 00 00    	mov    0xb84,%edx
 ...
 7d4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7d7:	89 15 84 0b 00 00    	mov    %edx,0xb84
}
 ...
 7e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7f0:	c7 05 84 0b 00 00 88 	movl   $0xb88,0xb84
 7f7:	0b 00 00 
 7fa:	c7 05 88 0b 00 00 88 	movl   $0xb88,0xb88
 801:	0b 00 00 
    base.s.size = 0;
 804:	b8 88 0b 00 00       	mov    $0xb88,%eax
 809:	c7 05 8c 0b 00 00 00 	movl   $0x0,0xb8c
 810:	00 00 00 
