...
stat(const char *n, struct stat *st)
{
 ...
 20d:	e8 18 01 00 00       	call   32a <open>
  if(fd < 0)
 ...
 221:	50                   	push   %eax
 222:	e8 cb 00 00 00       	call   2f2 <fstat>
  close(fd);
 227:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 22a:	89 c6                	mov    %eax,%esi
  close(fd);
 22c:	e8 29 01 00 00       	call   35a <close>
  return r;
...
0000032a <open>:
SYSCALL(open)
 32a:	b8 0f 00 00 00       	mov    $0xf,%eax
 32f:	cd 40                	int    $0x40
 331:	c3                   	ret    
...
0000034a <link>:
SYSCALL(link)
 34a:	b8 13 00 00 00       	mov    $0x13,%eax
 34f:	cd 40                	int    $0x40
 351:	c3                   	ret    

00000352 <mkdir>:
SYSCALL(mkdir)
 352:	b8 14 00 00 00       	mov    $0x14,%eax
 357:	cd 40                	int    $0x40
 359:	c3                   	ret    
 ...
 399:	85 d2                	test   %edx,%edx
{
 ...
 400:	e8 2d ff ff ff       	call   332 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 470:	e8 bd fe ff ff       	call   332 <write>
 ...
 4d1:	e8 5c fe ff ff       	call   332 <write>
 ...
 4e8:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 4ea:	e8 43 fe ff ff       	call   332 <write>
  for(i = 0; fmt[i]; i++){
 ...
 583:	57                   	push   %edi
 584:	53                   	push   %ebx
 585:	e8 a8 fd ff ff       	call   332 <write>
        while(*s != 0){
 ...
 5d7:	e8 56 fd ff ff       	call   332 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 6ee:	56                   	push   %esi
 6ef:	e8 1e fc ff ff       	call   312 <sbrk>
  if(p == (char*)-1)
