  ...
  21:	83 f8 01             	cmp    $0x1,%eax
{
  ...
  59:	e8 0c 04 00 00       	call   46a <close>
  for(i = 1; i < argc; i++){
...
stat(const char *n, struct stat *st)
{
 ...
 31d:	e8 18 01 00 00       	call   43a <open>
  if(fd < 0)
 ...
 331:	50                   	push   %eax
 332:	e8 cb 00 00 00       	call   402 <fstat>
  close(fd);
 337:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 33a:	89 c6                	mov    %eax,%esi
  close(fd);
 33c:	e8 29 01 00 00       	call   46a <close>
  return r;
 ...
 4a9:	85 d2                	test   %edx,%edx
{
 ...
 510:	e8 2d ff ff ff       	call   442 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 580:	e8 bd fe ff ff       	call   442 <write>
 ...
 5e1:	e8 5c fe ff ff       	call   442 <write>
 ...
 5f8:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 5fa:	e8 43 fe ff ff       	call   442 <write>
  for(i = 0; fmt[i]; i++){
 ...
 693:	57                   	push   %edi
 694:	53                   	push   %ebx
 695:	e8 a8 fd ff ff       	call   442 <write>
        while(*s != 0){
 ...
 6e7:	e8 56 fd ff ff       	call   442 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 7fe:	56                   	push   %esi
 7ff:	e8 1e fc ff ff       	call   422 <sbrk>
  if(p == (char*)-1)
