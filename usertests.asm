...
main(int argc, char *argv[])
{
  ...
  if(open("usertests.ran", 0) >= 0){
      ...
      26:	e8 df 38 00 00       	call   390a <open>
  ...
  close(open("usertests.ran", O_CREATE));
      ...
      51:	e8 b4 38 00 00       	call   390a <open>
      56:	89 04 24             	mov    %eax,(%esp)
      59:	e8 dc 38 00 00       	call   393a <close>
...
00000120 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
     ...
     13d:	e8 f0 37 00 00       	call   3932 <mkdir>
  ...
  if(chdir("iputdir") < 0){
     ...
     151:	e8 84 37 00 00       	call   38da <chdir>
  ...
  if(chdir("/") < 0){
     ...
     17d:	e8 58 37 00 00       	call   38da <chdir>
...
00000200 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     230:	e8 fd 36 00 00       	call   3932 <mkdir>
    ...
    if(chdir("iputdir") < 0){
     ...
     248:	e8 8d 36 00 00       	call   38da <chdir>
    ...
    if(unlink("../iputdir") < 0){
     ...
     25c:	e8 c1 36 00 00       	call   3922 <unlink>
...
000002f0 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
     ...
     30d:	e8 20 36 00 00       	call   3932 <mkdir>
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     336:	e8 cf 35 00 00       	call   390a <open>
    if(fd >= 0){
  ...
  sleep(1);
     ...
     363:	6a 01                	push   $0x1
     365:	e8 90 35 00 00       	call   38fa <sleep>
  if(unlink("oidir") != 0){
     36a:	c7 04 24 07 3e 00 00 	movl   $0x3e07,(%esp)
     371:	e8 ac 35 00 00       	call   3922 <unlink>
...
000003f0 <opentest>:
{
  ...
  fd = open("echo", 0);
     ...
     40f:	e8 f6 34 00 00       	call   390a <open>
  if(fd < 0){
  ...
  close(fd);
     ...
     41e:	50                   	push   %eax
     41f:	e8 16 35 00 00       	call   393a <close>
  fd = open("doesnotexist", 0);
     424:	5a                   	pop    %edx
     425:	59                   	pop    %ecx
     426:	6a 00                	push   $0x0
     428:	68 65 3e 00 00       	push   $0x3e65
     42d:	e8 d8 34 00 00       	call   390a <open>
  if(fd >= 0){
...
00000480 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     4a4:	e8 61 34 00 00       	call   390a <open>
  if(fd >= 0){
  ...
  for(i = 0; i < 100; i++){
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     4da:	56                   	push   %esi
     4db:	e8 32 34 00 00       	call   3912 <write>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     4f6:	56                   	push   %esi
     4f7:	e8 16 34 00 00       	call   3912 <write>
  ...
  close(fd);
     ...
     526:	e8 0f 34 00 00       	call   393a <close>
  fd = open("small", O_RDONLY);
     52b:	5b                   	pop    %ebx
     52c:	5e                   	pop    %esi
     52d:	6a 00                	push   $0x0
     52f:	68 af 3e 00 00       	push   $0x3eaf
     534:	e8 d1 33 00 00       	call   390a <open>
  if(fd >= 0){
  ...
  close(fd);
     ...
     590:	e8 a5 33 00 00       	call   393a <close>
  if(unlink("small") < 0){
     595:	c7 04 24 af 3e 00 00 	movl   $0x3eaf,(%esp)
     59c:	e8 81 33 00 00       	call   3922 <unlink>
...
00000660 <writetest1>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     684:	e8 81 32 00 00       	call   390a <open>
  if(fd < 0){
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     6b3:	56                   	push   %esi
     6b4:	e8 59 32 00 00       	call   3912 <write>
  ...
  close(fd);
     ...
     6d5:	56                   	push   %esi
     6d6:	e8 5f 32 00 00       	call   393a <close>
  fd = open("big", O_RDONLY);
     6db:	5b                   	pop    %ebx
     6dc:	5e                   	pop    %esi
     6dd:	6a 00                	push   $0x0
     6df:	68 f7 3f 00 00       	push   $0x3ff7
     6e4:	e8 21 32 00 00       	call   390a <open>
  if(fd < 0){
  ...
  close(fd);
     ...
     740:	56                   	push   %esi
     741:	e8 f4 31 00 00       	call   393a <close>
  if(unlink("big") < 0){
     746:	c7 04 24 f7 3f 00 00 	movl   $0x3ff7,(%esp)
     74d:	e8 d0 31 00 00       	call   3922 <unlink>
     ...
     834:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  name[2] = '\0';
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     876:	e8 8f 30 00 00       	call   390a <open>
    close(fd);
     87b:	89 04 24             	mov    %eax,(%esp)
     87e:	e8 b7 30 00 00       	call   393a <close>
  for(i = 0; i < 52; i++){
  ...
  name[2] = '\0';
    ...
    unlink(name);
     ...
     8b1:	e8 6c 30 00 00       	call   3922 <unlink>
  for(i = 0; i < 52; i++){
...
000008e0 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
     ...
     8fd:	e8 30 30 00 00       	call   3932 <mkdir>
  ...
  if(chdir("dir0") < 0){
     ...
     911:	e8 c4 2f 00 00       	call   38da <chdir>
  ...
  if(chdir("..") < 0){
     ...
     929:	e8 ac 2f 00 00       	call   38da <chdir>
  ...
  if(unlink("dir0") < 0){
     ...
     93d:	e8 e0 2f 00 00       	call   3922 <unlink>
...
000009c0 <exectest>:
{
  ...
  if(exec("echo", echoargv) < 0){
     ...
     9e2:	e8 e3 2e 00 00       	call   38ca <exec>
     ...
     a16:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  if(pid == 0){
    ...
    close(fds[1]);
     a4e:	e8 e7 2e 00 00       	call   393a <close>
    ...
    close(fds[0]);
     ...
     ace:	e8 67 2e 00 00       	call   393a <close>
     ...
     afe:	e8 0f 2e 00 00       	call   3912 <write>
    ...
    close(fds[0]);
     ...
     b33:	e8 02 2e 00 00       	call   393a <close>
    wait();
...
00000bb0 <preempt>:
{
  ...
  close(pfds[0]);
     ...
     c89:	e8 ac 2c 00 00       	call   393a <close>
  printf(1, "kill... ");
     c8e:	58                   	pop    %eax
     c8f:	5a                   	pop    %edx
  ...
  kill(pid2);
     ...
     ca7:	e8 16 2c 00 00       	call   38c2 <kill>
  kill(pid3);
     cac:	89 1c 24             	mov    %ebx,(%esp)
     caf:	e8 0e 2c 00 00       	call   38c2 <kill>
  printf(1, "wait... ");
     cb4:	59                   	pop    %ecx
     cb5:	5b                   	pop    %ebx
...
00000d80 <mem>:
{
  ...
  ppid = getpid();
     d97:	e8 4e 2b 00 00       	call   38ea <getpid>
  ...
  if((pid = fork()) == 0){
    ...
    exit();
     ...
     e2a:	e8 93 2a 00 00       	call   38c2 <kill>
      exit();
...
00000e50 <sharedfd>:
{
  ...
  unlink("sharedfd");
     ...
     e6c:	e8 b1 2a 00 00       	call   3922 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e71:	59                   	pop    %ecx
     e72:	5b                   	pop    %ebx
     e73:	68 02 02 00 00       	push   $0x202
     e78:	68 a3 41 00 00       	push   $0x41a3
     e7d:	e8 88 2a 00 00       	call   390a <open>
  if(fd < 0){
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ecd:	50                   	push   %eax
     ece:	56                   	push   %esi
     ecf:	e8 3e 2a 00 00       	call   3912 <write>
  ...
  close(fd);
     ...
     f06:	e8 2f 2a 00 00       	call   393a <close>
  fd = open("sharedfd", 0);
     f0b:	58                   	pop    %eax
     f0c:	5a                   	pop    %edx
     f0d:	6a 00                	push   $0x0
     f0f:	68 a3 41 00 00       	push   $0x41a3
     f14:	e8 f1 29 00 00       	call   390a <open>
  if(fd < 0){
  ...
  close(fd);
     ...
     f7c:	e8 b9 29 00 00       	call   393a <close>
  unlink("sharedfd");
     f81:	c7 04 24 a3 41 00 00 	movl   $0x41a3,(%esp)
     f88:	e8 95 29 00 00       	call   3922 <unlink>
    ...
    101b:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fourfiles test\n");
    ...
    104e:	56                   	push   %esi
    104f:	e8 ce 28 00 00       	call   3922 <unlink>
    pid = fork();
  ...
  for(i = 0; i < 2; i++){
    ...
    109f:	e8 66 28 00 00       	call   390a <open>
    while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    10f8:	e8 3d 28 00 00       	call   393a <close>
    if(total != 12*500){
    ...
    1112:	e8 0b 28 00 00       	call   3922 <unlink>
  for(i = 0; i < 2; i++){
  ...
  printf(1, "fourfiles ok\n");
    ...
    1151:	56                   	push   %esi
    1152:	e8 b3 27 00 00       	call   390a <open>
      if(fd < 0){
    ...
    118b:	56                   	push   %esi
    118c:	e8 81 27 00 00       	call   3912 <write>
    ...
    1216:	31 db                	xor    %ebx,%ebx
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1296:	88 45 c9             	mov    %al,-0x37(%ebp)
      fd = open(name, 0);
    1299:	e8 6c 26 00 00       	call   390a <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    12bf:	50                   	push   %eax
    12c0:	e8 75 26 00 00       	call   393a <close>
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    12f8:	88 45 c9             	mov    %al,-0x37(%ebp)
      unlink(name);
    12fb:	e8 22 26 00 00       	call   3922 <unlink>
    for(pi = 0; pi < 4; pi++){
  ...
  printf(1, "createdelete ok\n");
    ...
    1374:	88 45 c9             	mov    %al,-0x37(%ebp)
        fd = open(name, O_CREATE | O_RDWR);
    1377:	e8 8e 25 00 00       	call   390a <open>
        if(fd < 0){
    ...
    1386:	50                   	push   %eax
    1387:	e8 ae 25 00 00       	call   393a <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    13a3:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    13a6:	e8 77 25 00 00       	call   3922 <unlink>
...
00001430 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1450:	e8 b5 24 00 00       	call   390a <open>
  if(fd < 0){
  ...
  write(fd, "hello", 5);
    ...
    146c:	50                   	push   %eax
    146d:	e8 a0 24 00 00       	call   3912 <write>
  close(fd);
    1472:	89 1c 24             	mov    %ebx,(%esp)
    1475:	e8 c0 24 00 00       	call   393a <close>
  fd = open("unlinkread", O_RDWR);
    147a:	58                   	pop    %eax
    147b:	5a                   	pop    %edx
    147c:	6a 02                	push   $0x2
    147e:	68 55 42 00 00       	push   $0x4255
    1483:	e8 82 24 00 00       	call   390a <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
    ...
    149d:	e8 80 24 00 00       	call   3922 <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14ba:	e8 4b 24 00 00       	call   390a <open>
  write(fd1, "yyy", 3);
  ...
  write(fd1, "yyy", 3);
    ...
    14cb:	50                   	push   %eax
    14cc:	e8 41 24 00 00       	call   3912 <write>
  close(fd1);
    14d1:	89 34 24             	mov    %esi,(%esp)
    14d4:	e8 61 24 00 00       	call   393a <close>
  ...
  if(write(fd, buf, 10) != 10){
    ...
    150b:	53                   	push   %ebx
    150c:	e8 01 24 00 00       	call   3912 <write>
  ...
  close(fd);
    ...
    151c:	53                   	push   %ebx
    151d:	e8 18 24 00 00       	call   393a <close>
  unlink("unlinkread");
    1522:	c7 04 24 55 42 00 00 	movl   $0x4255,(%esp)
    1529:	e8 f4 23 00 00       	call   3922 <unlink>
...
000015c0 <linktest>:
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1613:	50                   	push   %eax
    1614:	e8 f9 22 00 00       	call   3912 <write>
  ...
  close(fd);
    ...
    1628:	53                   	push   %ebx
    1629:	e8 0c 23 00 00       	call   393a <close>
  if(link("lf1", "lf2") < 0){
    162e:	5b                   	pop    %ebx
    162f:	58                   	pop    %eax
    1630:	68 1a 43 00 00       	push   $0x431a
    1635:	68 16 43 00 00       	push   $0x4316
    163a:	e8 eb 22 00 00       	call   392a <link>
  ...
  unlink("lf1");
    ...
    1652:	e8 cb 22 00 00       	call   3922 <unlink>
  if(open("lf1", 0) >= 0){
    1657:	58                   	pop    %eax
    1658:	5a                   	pop    %edx
    1659:	6a 00                	push   $0x0
    165b:	68 16 43 00 00       	push   $0x4316
    1660:	e8 a5 22 00 00       	call   390a <open>
  ...
  fd = open("lf2", 0);
    ...
    167a:	e8 8b 22 00 00       	call   390a <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    16ae:	53                   	push   %ebx
    16af:	e8 86 22 00 00       	call   393a <close>
  if(link("lf2", "lf2") >= 0){
    16b4:	58                   	pop    %eax
    16b5:	5a                   	pop    %edx
    16b6:	68 1a 43 00 00       	push   $0x431a
    16bb:	68 1a 43 00 00       	push   $0x431a
    16c0:	e8 65 22 00 00       	call   392a <link>
  ...
  unlink("lf2");
    ...
    16d8:	e8 45 22 00 00       	call   3922 <unlink>
  if(link("lf2", "lf1") >= 0){
    16dd:	59                   	pop    %ecx
    16de:	5b                   	pop    %ebx
    16df:	68 16 43 00 00       	push   $0x4316
    16e4:	68 1a 43 00 00       	push   $0x431a
    16e9:	e8 3c 22 00 00       	call   392a <link>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1702:	e8 23 22 00 00       	call   392a <link>
    ...
    17db:	bf ab aa aa aa       	mov    $0xaaaaaaab,%edi
{
  ...
  file[2] = '\0';
    ...
    181e:	53                   	push   %ebx
    181f:	e8 e6 20 00 00       	call   390a <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    182e:	83 c6 01             	add    $0x1,%esi
      close(fd);
    1831:	50                   	push   %eax
    1832:	e8 03 21 00 00       	call   393a <close>
  ...
  for(i = 0; i < 40; i++){
    ...
    unlink(file);
    1852:	e8 cb 20 00 00       	call   3922 <unlink>
    pid = fork();
    ...
    1881:	53                   	push   %ebx
    1882:	e8 83 20 00 00       	call   390a <open>
      if(fd < 0){
    ...
    18b9:	e8 6c 20 00 00       	call   392a <link>
  ...
  for(i = 0; i < 40; i++){
    ...
    18dc:	e8 49 20 00 00       	call   392a <link>
  ...
  fd = open(".", 0);
    ...
    190e:	e8 f7 1f 00 00       	call   390a <open>
  ...
  close(fd);
    ...
    1973:	56                   	push   %esi
    1974:	e8 c1 1f 00 00       	call   393a <close>
  if(n != 40){
  ...
  for(i = 0; i < 40; i++){
    ...
    199c:	53                   	push   %ebx
    199d:	e8 80 1f 00 00       	call   3922 <unlink>
      unlink(file);
    19a2:	89 1c 24             	mov    %ebx,(%esp)
    19a5:	e8 78 1f 00 00       	call   3922 <unlink>
      unlink(file);
  ...
  for(i = 0; i < 40; i++){
    ...
    1a00:	6a 00                	push   $0x0
    1a02:	53                   	push   %ebx
    1a03:	e8 02 1f 00 00       	call   390a <open>
    1a08:	89 04 24             	mov    %eax,(%esp)
    1a0b:	e8 2a 1f 00 00       	call   393a <close>
      close(open(file, 0));
    1a10:	58                   	pop    %eax
    1a11:	5a                   	pop    %edx
    1a12:	6a 00                	push   $0x0
    1a14:	53                   	push   %ebx
    1a15:	e8 f0 1e 00 00       	call   390a <open>
    1a1a:	89 04 24             	mov    %eax,(%esp)
    1a1d:	e8 18 1f 00 00       	call   393a <close>
      close(open(file, 0));
    1a22:	59                   	pop    %ecx
    1a23:	58                   	pop    %eax
    1a24:	6a 00                	push   $0x0
    1a26:	53                   	push   %ebx
    1a27:	e8 de 1e 00 00       	call   390a <open>
    1a2c:	89 04 24             	mov    %eax,(%esp)
    1a2f:	e8 06 1f 00 00       	call   393a <close>
      close(open(file, 0));
    1a34:	58                   	pop    %eax
    1a35:	5a                   	pop    %edx
    1a36:	6a 00                	push   $0x0
    1a38:	53                   	push   %ebx
    1a39:	e8 cc 1e 00 00       	call   390a <open>
    1a3e:	89 04 24             	mov    %eax,(%esp)
    1a41:	e8 f4 1e 00 00       	call   393a <close>
  ...
  printf(1, "concreate ok\n");
    ...
    1abd:	50                   	push   %eax
    1abe:	e8 77 1e 00 00       	call   393a <close>
...
00001ad0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1aec:	e8 31 1e 00 00       	call   3922 <unlink>
  pid = fork();
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b2d:	e8 f0 1d 00 00       	call   3922 <unlink>
  ...
  for(i = 0; i < 100; i++){
    ...
    1b62:	e8 a3 1d 00 00       	call   390a <open>
    1b67:	89 04 24             	mov    %eax,(%esp)
    1b6a:	e8 cb 1d 00 00       	call   393a <close>
  ...
  printf(1, "linkunlink ok\n");
    ...
    1bad:	e8 78 1d 00 00       	call   392a <link>
...
00001be0 <bigdir>:
{
  ...
  unlink("bd");
    ...
    1bfc:	e8 21 1d 00 00       	call   3922 <unlink>
  fd = open("bd", O_CREATE);
    1c01:	5a                   	pop    %edx
    1c02:	59                   	pop    %ecx
    1c03:	68 00 02 00 00       	push   $0x200
    1c08:	68 65 44 00 00       	push   $0x4465
    1c0d:	e8 f8 1c 00 00       	call   390a <open>
  if(fd < 0){
  ...
  close(fd);
    1c25:	50                   	push   %eax
    1c26:	e8 0f 1d 00 00       	call   393a <close>
    ...
    if(link("bd", name) != 0){
    1c57:	e8 ce 1c 00 00       	call   392a <link>
  ...
  unlink("bd");
    ...
    1c78:	e8 a5 1c 00 00       	call   3922 <unlink>
    ...
    if(unlink(name) != 0){
    1ca2:	e8 7b 1c 00 00       	call   3922 <unlink>
...
00001d10 <subdir>:
{
  ...
  unlink("ff");
    ...
    1d2a:	e8 f3 1b 00 00       	call   3922 <unlink>
  if(mkdir("dd") != 0){
    1d2f:	c7 04 24 d8 45 00 00 	movl   $0x45d8,(%esp)
    1d36:	e8 f7 1b 00 00       	call   3932 <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d53:	e8 b2 1b 00 00       	call   390a <open>
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    1d6f:	50                   	push   %eax
    1d70:	e8 9d 1b 00 00       	call   3912 <write>
  close(fd);
    1d75:	89 1c 24             	mov    %ebx,(%esp)
    1d78:	e8 bd 1b 00 00       	call   393a <close>
  if(unlink("dd") >= 0){
    1d7d:	c7 04 24 d8 45 00 00 	movl   $0x45d8,(%esp)
    1d84:	e8 99 1b 00 00       	call   3922 <unlink>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1d9c:	e8 91 1b 00 00       	call   3932 <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1db9:	e8 4c 1b 00 00       	call   390a <open>
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    1dd5:	50                   	push   %eax
    1dd6:	e8 37 1b 00 00       	call   3912 <write>
  close(fd);
    1ddb:	89 1c 24             	mov    %ebx,(%esp)
    1dde:	e8 57 1b 00 00       	call   393a <close>
  fd = open("dd/dd/../ff", 0);
    1de3:	58                   	pop    %eax
    1de4:	5a                   	pop    %edx
    1de5:	6a 00                	push   $0x0
    1de7:	68 32 45 00 00       	push   $0x4532
    1dec:	e8 19 1b 00 00       	call   390a <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    1e2d:	53                   	push   %ebx
    1e2e:	e8 07 1b 00 00       	call   393a <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e33:	5b                   	pop    %ebx
    1e34:	58                   	pop    %eax
    1e35:	68 72 45 00 00       	push   $0x4572
    1e3a:	68 0e 45 00 00       	push   $0x450e
    1e3f:	e8 e6 1a 00 00       	call   392a <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e57:	e8 c6 1a 00 00       	call   3922 <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1e71:	e8 94 1a 00 00       	call   390a <open>
  ...
  if(chdir("dd") != 0){
    ...
    1e89:	e8 4c 1a 00 00       	call   38da <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1ea1:	e8 34 1a 00 00       	call   38da <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1eb9:	e8 1c 1a 00 00       	call   38da <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    1ed1:	e8 04 1a 00 00       	call   38da <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1eeb:	e8 1a 1a 00 00       	call   390a <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    1f1f:	53                   	push   %ebx
    1f20:	e8 15 1a 00 00       	call   393a <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    1f25:	59                   	pop    %ecx
    1f26:	5b                   	pop    %ebx
    1f27:	6a 00                	push   $0x0
    1f29:	68 0e 45 00 00       	push   $0x450e
    1f2e:	e8 d7 19 00 00       	call   390a <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f4b:	e8 ba 19 00 00       	call   390a <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f68:	e8 9d 19 00 00       	call   390a <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f85:	e8 80 19 00 00       	call   390a <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1f9f:	e8 66 19 00 00       	call   390a <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fb9:	e8 4c 19 00 00       	call   390a <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fd6:	e8 4f 19 00 00       	call   392a <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    1ff3:	e8 32 19 00 00       	call   392a <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2010:	e8 15 19 00 00       	call   392a <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2028:	e8 05 19 00 00       	call   3932 <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2040:	e8 ed 18 00 00       	call   3932 <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2058:	e8 d5 18 00 00       	call   3932 <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2070:	e8 ad 18 00 00       	call   3922 <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2088:	e8 95 18 00 00       	call   3922 <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    20a0:	e8 35 18 00 00       	call   38da <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    20b8:	e8 1d 18 00 00       	call   38da <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    20d0:	e8 4d 18 00 00       	call   3922 <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    20e8:	e8 35 18 00 00       	call   3922 <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    2100:	e8 1d 18 00 00       	call   3922 <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    2118:	e8 05 18 00 00       	call   3922 <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    2130:	e8 ed 17 00 00       	call   3922 <unlink>
...
000023f0 <bigwrite>:
{
  ...
  unlink("bigwrite");
    ...
    2410:	e8 0d 15 00 00       	call   3922 <unlink>
    ...
    242d:	e8 d8 14 00 00       	call   390a <open>
    if(fd < 0){
    ...
    2444:	50                   	push   %eax
    2445:	e8 c8 14 00 00       	call   3912 <write>
      if(cc != sz){
    ...
    245a:	56                   	push   %esi
    245b:	e8 b2 14 00 00       	call   3912 <write>
      if(cc != sz){
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    close(fd);
    2470:	56                   	push   %esi
    2471:	e8 c4 14 00 00       	call   393a <close>
    unlink("bigwrite");
    2476:	c7 04 24 d4 47 00 00 	movl   $0x47d4,(%esp)
    247d:	e8 a0 14 00 00       	call   3922 <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
...
000024d0 <bigfile>:
{
  ...
  unlink("bigfile");
    ...
    24ec:	e8 31 14 00 00       	call   3922 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    24f1:	58                   	pop    %eax
    24f2:	5a                   	pop    %edx
    24f3:	68 02 02 00 00       	push   $0x202
    24f8:	68 30 48 00 00       	push   $0x4830
    24fd:	e8 08 14 00 00       	call   390a <open>
  if(fd < 0){
  ...
  for(i = 0; i < 20; i++){
    ...
    2538:	56                   	push   %esi
    2539:	e8 d4 13 00 00       	call   3912 <write>
  ...
  close(fd);
    ...
    2557:	56                   	push   %esi
    2558:	e8 dd 13 00 00       	call   393a <close>
  fd = open("bigfile", 0);
    255d:	5e                   	pop    %esi
    255e:	5f                   	pop    %edi
    255f:	6a 00                	push   $0x0
    2561:	68 30 48 00 00       	push   $0x4830
    2566:	e8 9f 13 00 00       	call   390a <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    25cd:	56                   	push   %esi
    25ce:	e8 67 13 00 00       	call   393a <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    25ea:	e8 33 13 00 00       	call   3922 <unlink>
...
000026a0 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    26b9:	e8 74 12 00 00       	call   3932 <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26d1:	e8 5c 12 00 00       	call   3932 <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26ee:	e8 17 12 00 00       	call   390a <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2701:	50                   	push   %eax
    2702:	e8 33 12 00 00       	call   393a <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    2707:	58                   	pop    %eax
    2708:	5a                   	pop    %edx
    2709:	6a 00                	push   $0x0
    270b:	68 88 51 00 00       	push   $0x5188
    2710:	e8 f5 11 00 00       	call   390a <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    271f:	50                   	push   %eax
    2720:	e8 15 12 00 00       	call   393a <close>
  if(mkdir("12345678901234/12345678901234") == 0){
    2725:	c7 04 24 fc 48 00 00 	movl   $0x48fc,(%esp)
    272c:	e8 01 12 00 00       	call   3932 <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2740:	e8 ed 11 00 00       	call   3932 <mkdir>
...
000027e0 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    27f9:	e8 34 11 00 00       	call   3932 <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    2811:	e8 c4 10 00 00       	call   38da <chdir>
  ...
  if(unlink(".") == 0){
    ...
    2829:	e8 f4 10 00 00       	call   3922 <unlink>
  ...
  if(unlink("..") == 0){
    ...
    2841:	e8 dc 10 00 00       	call   3922 <unlink>
  ...
  if(chdir("/") != 0){
    ...
    2859:	e8 7c 10 00 00       	call   38da <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    2871:	e8 ac 10 00 00       	call   3922 <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    2885:	e8 98 10 00 00       	call   3922 <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    2899:	e8 84 10 00 00       	call   3922 <unlink>
...
00002960 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    297f:	e8 86 0f 00 00       	call   390a <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2992:	50                   	push   %eax
    2993:	e8 a2 0f 00 00       	call   393a <close>
  if(chdir("dirfile") == 0){
    2998:	c7 04 24 e5 49 00 00 	movl   $0x49e5,(%esp)
    299f:	e8 36 0f 00 00       	call   38da <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    29b9:	e8 4c 0f 00 00       	call   390a <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29d6:	e8 2f 0f 00 00       	call   390a <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29ee:	e8 3f 0f 00 00       	call   3932 <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2a06:	e8 17 0f 00 00       	call   3922 <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a23:	e8 02 0f 00 00       	call   392a <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2a3b:	e8 e2 0e 00 00       	call   3922 <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2a55:	e8 b0 0e 00 00       	call   390a <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2a6f:	e8 96 0e 00 00       	call   390a <open>
  if(write(fd, "x", 1) > 0){
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2a80:	50                   	push   %eax
    2a81:	e8 8c 0e 00 00       	call   3912 <write>
  ...
  close(fd);
    ...
    2a90:	53                   	push   %ebx
    2a91:	e8 a4 0e 00 00       	call   393a <close>
    ...
    2b64:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    ...
    2b88:	e8 a5 0d 00 00       	call   3932 <mkdir>
    ...
    2ba0:	e8 35 0d 00 00       	call   38da <chdir>
  ...
  chdir("/");
    ...
    2c38:	e8 9d 0c 00 00       	call   38da <chdir>
    ...
    2d36:	31 ff                	xor    %edi,%edi
{
  ...
  oldbrk = sbrk(0);
    ...
    2d52:	e8 9b 0b 00 00       	call   38f2 <sbrk>
  a = sbrk(0);
    2d57:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  oldbrk = sbrk(0);
    2d5e:	89 c3                	mov    %eax,%ebx
  a = sbrk(0);
    2d60:	e8 8d 0b 00 00       	call   38f2 <sbrk>
    ...
    2d75:	6a 01                	push   $0x1
    2d77:	e8 76 0b 00 00       	call   38f2 <sbrk>
    if(b != a){
  ...
  c = sbrk(1);
    2dad:	6a 01                	push   $0x1
    2daf:	e8 3e 0b 00 00       	call   38f2 <sbrk>
  c = sbrk(1);
    2db4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dbb:	e8 32 0b 00 00       	call   38f2 <sbrk>
  if(c != a + 1){
  ...
  a = sbrk(0);
    ...
    2ddb:	6a 00                	push   $0x0
    2ddd:	e8 10 0b 00 00       	call   38f2 <sbrk>
  ...
  p = sbrk(amt);
    ...
    2dee:	e8 ff 0a 00 00       	call   38f2 <sbrk>
  if (p != a) {
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    2e08:	6a 00                	push   $0x0
    2e0a:	e8 e3 0a 00 00       	call   38f2 <sbrk>
  c = sbrk(-4096);
    2e0f:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
  a = sbrk(0);
    2e16:	89 c6                	mov    %eax,%esi
  c = sbrk(-4096);
    2e18:	e8 d5 0a 00 00       	call   38f2 <sbrk>
  ...
  c = sbrk(0);
    ...
    2e2c:	6a 00                	push   $0x0
    2e2e:	e8 bf 0a 00 00       	call   38f2 <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2e47:	6a 00                	push   $0x0
    2e49:	e8 a4 0a 00 00       	call   38f2 <sbrk>
    2e4e:	89 c6                	mov    %eax,%esi
  c = sbrk(4096);
    2e50:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
    2e57:	e8 96 0a 00 00       	call   38f2 <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2e6c:	6a 00                	push   $0x0
    2e6e:	e8 7f 0a 00 00       	call   38f2 <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    ppid = getpid();
    2ec5:	e8 20 0a 00 00       	call   38ea <getpid>
  ...
  c = sbrk(4096);
    ...
    2f9f:	50                   	push   %eax
    2fa0:	e8 1d 09 00 00       	call   38c2 <kill>
    wait();
  ...
  if(sbrk(0) > oldbrk)
    ...
    2fbd:	6a 00                	push   $0x0
    2fbf:	e8 2e 09 00 00       	call   38f2 <sbrk>
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    300a:	6a 00                	push   $0x0
    300c:	e8 e1 08 00 00       	call   38f2 <sbrk>
    3011:	29 c3                	sub    %eax,%ebx
    3013:	89 1c 24             	mov    %ebx,(%esp)
    3016:	e8 d7 08 00 00       	call   38f2 <sbrk>
    ...
    3062:	e8 5b 08 00 00       	call   38c2 <kill>
      exit();
...
00003150 <validatetest>:
{
  ...
  printf(stdout, "validate test\n");
    ...
    317e:	6a 00                	push   $0x0
    3180:	e8 75 07 00 00       	call   38fa <sleep>
    sleep(0);
    3185:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    318c:	e8 69 07 00 00       	call   38fa <sleep>
    kill(pid);
    3191:	89 34 24             	mov    %esi,(%esp)
    3194:	e8 29 07 00 00       	call   38c2 <kill>
    wait();
    ...
    31a6:	e8 7f 07 00 00       	call   392a <link>
...
00003280 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    328b:	e8 92 06 00 00       	call   3922 <unlink>
  pid = fork();
  ...
  fd = open("bigarg-ok", 0);
    ...
    32b1:	e8 54 06 00 00       	call   390a <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    32c4:	50                   	push   %eax
    32c5:	e8 70 06 00 00       	call   393a <close>
  unlink("bigarg-ok");
    32ca:	c7 04 24 76 4c 00 00 	movl   $0x4c76,(%esp)
    32d1:	e8 4c 06 00 00       	call   3922 <unlink>
}
    ...
    3318:	e8 ad 05 00 00       	call   38ca <exec>
    ...
    333b:	e8 ca 05 00 00       	call   390a <open>
    close(fd);
    3340:	89 04 24             	mov    %eax,(%esp)
    3343:	e8 f2 05 00 00       	call   393a <close>
    exit();
    ...
    3386:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fsfull test\n");
    ...
    342a:	50                   	push   %eax
    342b:	e8 da 04 00 00       	call   390a <open>
    if(fd < 0){
    ...
    344f:	57                   	push   %edi
    3450:	e8 bd 04 00 00       	call   3912 <write>
      if(cc < 512)
    ...
    3472:	e8 c3 04 00 00       	call   393a <close>
    if(total == 0)
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3519:	50                   	push   %eax
    351a:	e8 03 04 00 00       	call   3922 <unlink>
  while(nfiles >= 0){
...
000035c0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    35ce:	e8 37 03 00 00       	call   390a <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    35df:	6a 00                	push   $0x0
    35e1:	e8 0c 03 00 00       	call   38f2 <sbrk>
  ...
  close(fd);
    ...
    35f8:	e8 3d 03 00 00       	call   393a <close>
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    37ed:	e8 18 01 00 00       	call   390a <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    3801:	50                   	push   %eax
    3802:	e8 cb 00 00 00       	call   38d2 <fstat>
  close(fd);
    3807:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
    380a:	89 c6                	mov    %eax,%esi
  close(fd);
    380c:	e8 29 01 00 00       	call   393a <close>
  return r;
...
000038d2 <fstat>:
SYSCALL(fstat)
    38d2:	b8 08 00 00 00       	mov    $0x8,%eax
    38d7:	cd 40                	int    $0x40
    38d9:	c3                   	ret    

000038da <chdir>:
SYSCALL(chdir)
    38da:	b8 09 00 00 00       	mov    $0x9,%eax
    38df:	cd 40                	int    $0x40
    38e1:	c3                   	ret    

000038e2 <dup>:
SYSCALL(dup)
    38e2:	b8 0a 00 00 00       	mov    $0xa,%eax
    38e7:	cd 40                	int    $0x40
    38e9:	c3                   	ret    

000038ea <getpid>:
SYSCALL(getpid)
    38ea:	b8 0b 00 00 00       	mov    $0xb,%eax
    38ef:	cd 40                	int    $0x40
    38f1:	c3                   	ret    

000038f2 <sbrk>:
SYSCALL(sbrk)
    38f2:	b8 0c 00 00 00       	mov    $0xc,%eax
    38f7:	cd 40                	int    $0x40
    38f9:	c3                   	ret    

000038fa <sleep>:
SYSCALL(sleep)
    38fa:	b8 0d 00 00 00       	mov    $0xd,%eax
    38ff:	cd 40                	int    $0x40
    3901:	c3                   	ret    

00003902 <uptime>:
SYSCALL(uptime)
    3902:	b8 0e 00 00 00       	mov    $0xe,%eax
    3907:	cd 40                	int    $0x40
    3909:	c3                   	ret    

0000390a <open>:
SYSCALL(open)
    390a:	b8 0f 00 00 00       	mov    $0xf,%eax
    390f:	cd 40                	int    $0x40
    3911:	c3                   	ret    

00003912 <write>:
SYSCALL(write)
    3912:	b8 10 00 00 00       	mov    $0x10,%eax
    3917:	cd 40                	int    $0x40
    3919:	c3                   	ret    
...
0000392a <link>:
SYSCALL(link)
    392a:	b8 13 00 00 00       	mov    $0x13,%eax
    392f:	cd 40                	int    $0x40
    3931:	c3                   	ret    

00003932 <mkdir>:
SYSCALL(mkdir)
    3932:	b8 14 00 00 00       	mov    $0x14,%eax
    3937:	cd 40                	int    $0x40
    3939:	c3                   	ret    

0000393a <close>:
SYSCALL(close)
    393a:	b8 15 00 00 00       	mov    $0x15,%eax
    393f:	cd 40                	int    $0x40
    3941:	c3                   	ret    
    ...
    3979:	85 d2                	test   %edx,%edx
{
  ...
  write(fd, &c, 1);
    ...
    39e0:	e8 2d ff ff ff       	call   3912 <write>
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    3a50:	e8 bd fe ff ff       	call   3912 <write>
  ...
  write(fd, &c, 1);
    ...
    3ab1:	e8 5c fe ff ff       	call   3912 <write>
  ...
  write(fd, &c, 1);
    3aca:	e8 43 fe ff ff       	call   3912 <write>
  for(i = 0; fmt[i]; i++){
  ...
  write(fd, &c, 1);
    ...
    3b63:	57                   	push   %edi
    3b64:	53                   	push   %ebx
    3b65:	e8 a8 fd ff ff       	call   3912 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    3bb7:	e8 56 fd ff ff       	call   3912 <write>
        ap++;
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3cce:	56                   	push   %esi
    3ccf:	e8 1e fc ff ff       	call   38f2 <sbrk>
  if(p == (char*)-1)
