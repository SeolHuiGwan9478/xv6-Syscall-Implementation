...
_testgetnp:     file format elf32-i386
...
int main(void){
 ...
 printf(1, "Current # of NP : %d\n",getnp());
  1d:	e8 18 03 00 00       	call   33a <getnp>
  22:	83 c4 0c             	add    $0xc,%esp
  25:	50                   	push   %eax
  26:	68 66 07 00 00       	push   $0x766
  2b:	6a 01                	push   $0x1
  2d:	e8 ce 03 00 00       	call   400 <printf>

 exit();
  32:	e8 5b 02 00 00       	call   292 <exit>
  37:	66 90                	xchg   %ax,%ax
  39:	66 90                	xchg   %ax,%ax
  3b:	66 90                	xchg   %ax,%ax
  3d:	66 90                	xchg   %ax,%ax
...
stat(const char *n, struct stat *st)
{
 ...
 1dd:	e8 18 01 00 00       	call   2fa <open>
  if(fd < 0)
 ...
 1f1:	50                   	push   %eax
 1f2:	e8 cb 00 00 00       	call   2c2 <fstat>
  close(fd);
 1f7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 1fa:	89 c6                	mov    %eax,%esi
  close(fd);
 1fc:	e8 29 01 00 00       	call   32a <close>
  return r;
 ...
 369:	85 d2                	test   %edx,%edx
{
 ...
 3d0:	e8 2d ff ff ff       	call   302 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 440:	e8 bd fe ff ff       	call   302 <write>
 ...
 4a1:	e8 5c fe ff ff       	call   302 <write>
 ...
 4b8:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 4ba:	e8 43 fe ff ff       	call   302 <write>
  for(i = 0; fmt[i]; i++){
 ...
 553:	57                   	push   %edi
 554:	53                   	push   %ebx
 555:	e8 a8 fd ff ff       	call   302 <write>
        while(*s != 0){
 ...
 5a7:	e8 56 fd ff ff       	call   302 <write>
        ap++;
 ...
 5b4:	e9 8f fe ff ff       	jmp    448 <printf+0x48>
          s = "(null)";
 5b9:	bb 7c 07 00 00       	mov    $0x77c,%ebx
        while(*s != 0){
 ...
 5d1:	a1 28 0a 00 00       	mov    0xa28,%eax
{
 ...
 60d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 60f:	a3 28 0a 00 00       	mov    %eax,0xa28
}
 614:	5b                   	pop    %ebx
 615:	5e                   	pop    %esi
 616:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 15 28 0a 00 00    	mov    0xa28,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6d6:	e8 f5 fe ff ff       	call   5d0 <free>
  return freep;
 6db:	8b 15 28 0a 00 00    	mov    0xa28,%edx
 ...
 704:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 707:	89 15 28 0a 00 00    	mov    %edx,0xa28
}
 ...
 719:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 28 0a 00 00 2c 	movl   $0xa2c,0xa28
 727:	0a 00 00 
 72a:	c7 05 2c 0a 00 00 2c 	movl   $0xa2c,0xa2c
 731:	0a 00 00 
    base.s.size = 0;
 734:	b8 2c 0a 00 00       	mov    $0xa2c,%eax
 739:	c7 05 30 0a 00 00 00 	movl   $0x0,0xa30
 740:	00 00 00 
