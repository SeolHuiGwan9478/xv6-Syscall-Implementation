   ...
   7:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  32:	e8 03 03 00 00       	call   33a <link>
...
stat(const char *n, struct stat *st)
{
 ...
 1fd:	e8 18 01 00 00       	call   31a <open>
  if(fd < 0)
 ...
 211:	50                   	push   %eax
 212:	e8 cb 00 00 00       	call   2e2 <fstat>
  close(fd);
 217:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 21a:	89 c6                	mov    %eax,%esi
  close(fd);
 21c:	e8 29 01 00 00       	call   34a <close>
  return r;
 ...
 389:	85 d2                	test   %edx,%edx
{
 ...
 3f0:	e8 2d ff ff ff       	call   322 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 4c1:	e8 5c fe ff ff       	call   322 <write>
 ...
 4d8:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 4da:	e8 43 fe ff ff       	call   322 <write>
  for(i = 0; fmt[i]; i++){
 ...
 573:	57                   	push   %edi
 574:	53                   	push   %ebx
 575:	e8 a8 fd ff ff       	call   322 <write>
        while(*s != 0){
 ...
 5c7:	e8 56 fd ff ff       	call   322 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 6de:	56                   	push   %esi
 6df:	e8 1e fc ff ff       	call   302 <sbrk>
  if(p == (char*)-1)
