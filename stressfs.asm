  ...
  1c:	31 db                	xor    %ebx,%ebx
{
  ...
  a2:	50                   	push   %eax
  a3:	e8 52 03 00 00       	call   3fa <open>
...
//    printf(fd, "%d\n", i);
  ...
  ca:	57                   	push   %edi
  cb:	e8 5a 03 00 00       	call   42a <close>
  ...
  ee:	e8 07 03 00 00       	call   3fa <open>
 ...
 11a:	57                   	push   %edi
 11b:	e8 0a 03 00 00       	call   42a <close>
...
stat(const char *n, struct stat *st)
{
 ...
 2dd:	e8 18 01 00 00       	call   3fa <open>
  if(fd < 0)
 ...
 2f1:	50                   	push   %eax
 2f2:	e8 cb 00 00 00       	call   3c2 <fstat>
  close(fd);
 2f7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2fa:	89 c6                	mov    %eax,%esi
  close(fd);
 2fc:	e8 29 01 00 00       	call   42a <close>
  return r;
 ...
 469:	85 d2                	test   %edx,%edx
{
 ...
 4d0:	e8 2d ff ff ff       	call   402 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 5a1:	e8 5c fe ff ff       	call   402 <write>
 ...
 5b8:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 5ba:	e8 43 fe ff ff       	call   402 <write>
  for(i = 0; fmt[i]; i++){
 ...
 653:	57                   	push   %edi
 654:	53                   	push   %ebx
 655:	e8 a8 fd ff ff       	call   402 <write>
        while(*s != 0){
 ...
 6a7:	e8 56 fd ff ff       	call   402 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 7be:	56                   	push   %esi
 7bf:	e8 1e fc ff ff       	call   3e2 <sbrk>
  if(p == (char*)-1)
