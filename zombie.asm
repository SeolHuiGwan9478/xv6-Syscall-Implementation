...
main(void)
{
  ...
  1d:	6a 05                	push   $0x5
  1f:	e8 b6 02 00 00       	call   2da <sleep>
...
stat(const char *n, struct stat *st)
{
 ...
 1cd:	e8 18 01 00 00       	call   2ea <open>
  if(fd < 0)
 ...
 1e1:	50                   	push   %eax
 1e2:	e8 cb 00 00 00       	call   2b2 <fstat>
  close(fd);
 1e7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 1ea:	89 c6                	mov    %eax,%esi
  close(fd);
 1ec:	e8 29 01 00 00       	call   31a <close>
  return r;
...
000002ba <chdir>:
SYSCALL(chdir)
 2ba:	b8 09 00 00 00       	mov    $0x9,%eax
 2bf:	cd 40                	int    $0x40
 2c1:	c3                   	ret    

000002c2 <dup>:
SYSCALL(dup)
 2c2:	b8 0a 00 00 00       	mov    $0xa,%eax
 2c7:	cd 40                	int    $0x40
 2c9:	c3                   	ret    
...
000002d2 <sbrk>:
SYSCALL(sbrk)
 2d2:	b8 0c 00 00 00       	mov    $0xc,%eax
 2d7:	cd 40                	int    $0x40
 2d9:	c3                   	ret    

000002da <sleep>:
SYSCALL(sleep)
 2da:	b8 0d 00 00 00       	mov    $0xd,%eax
 2df:	cd 40                	int    $0x40
 2e1:	c3                   	ret    

000002e2 <uptime>:
SYSCALL(uptime)
 2e2:	b8 0e 00 00 00       	mov    $0xe,%eax
 2e7:	cd 40                	int    $0x40
 2e9:	c3                   	ret    
 ...
 359:	85 d2                	test   %edx,%edx
{
 ...
 3c0:	e8 2d ff ff ff       	call   2f2 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 491:	e8 5c fe ff ff       	call   2f2 <write>
 ...
 543:	57                   	push   %edi
 544:	53                   	push   %ebx
 545:	e8 a8 fd ff ff       	call   2f2 <write>
        while(*s != 0){
 ...
 597:	e8 56 fd ff ff       	call   2f2 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 6ae:	56                   	push   %esi
 6af:	e8 1e fc ff ff       	call   2d2 <sbrk>
  if(p == (char*)-1)
