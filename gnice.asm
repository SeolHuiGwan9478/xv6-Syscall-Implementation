...
int main(int argc, char *argv[]){
  ...
  14:	8b 40 04             	mov    0x4(%eax),%eax
	...
	if(argv1[0] == '-'){
  17:	80 38 2d             	cmpb   $0x2d,(%eax)
  1a:	74 33                	je     4f <main+0x4f>
		argv1 = &argv1[1];
		pid = atoi(argv1);
		pid *= -1;
	}
  ...
  1f:	50                   	push   %eax
  20:	e8 3b 02 00 00       	call   260 <atoi>
  ...
  2b:	50                   	push   %eax
  2c:	e8 51 03 00 00       	call   382 <getnice>
	if(nice == -1){ //no PID
  31:	83 c4 10             	add    $0x10,%esp
  34:	83 f8 ff             	cmp    $0xffffffff,%eax
  37:	74 29                	je     62 <main+0x62>
  ...
  52:	83 c0 01             	add    $0x1,%eax
		pid = atoi(argv1);
  55:	50                   	push   %eax
  56:	e8 05 02 00 00       	call   260 <atoi>
  5b:	83 c4 10             	add    $0x10,%esp
		pid *= -1;
  5e:	f7 d8                	neg    %eax
  60:	eb c6                	jmp    28 <main+0x28>
		printf(1,"Does not exist PID.\n"); 
  62:	51                   	push   %ecx
  63:	51                   	push   %ecx
...
stat(const char *n, struct stat *st)
{
 ...
 21d:	e8 18 01 00 00       	call   33a <open>
  if(fd < 0)
 ...
 231:	50                   	push   %eax
 232:	e8 cb 00 00 00       	call   302 <fstat>
  close(fd);
 237:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 23a:	89 c6                	mov    %eax,%esi
  close(fd);
 23c:	e8 29 01 00 00       	call   36a <close>
  return r;
 ...
 3a9:	85 d2                	test   %edx,%edx
{
 ...
 410:	e8 2d ff ff ff       	call   342 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 480:	e8 bd fe ff ff       	call   342 <write>
 ...
 4e1:	e8 5c fe ff ff       	call   342 <write>
 ...
 4f8:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 4fa:	e8 43 fe ff ff       	call   342 <write>
  for(i = 0; fmt[i]; i++){
 ...
 593:	57                   	push   %edi
 594:	53                   	push   %ebx
 595:	e8 a8 fd ff ff       	call   342 <write>
        while(*s != 0){
 ...
 5e7:	e8 56 fd ff ff       	call   342 <write>
        ap++;
 ...
 5f4:	e9 8f fe ff ff       	jmp    488 <printf+0x48>
          s = "(null)";
 5f9:	bb be 07 00 00       	mov    $0x7be,%ebx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 6fe:	56                   	push   %esi
 6ff:	e8 1e fc ff ff       	call   322 <sbrk>
  if(p == (char*)-1)
